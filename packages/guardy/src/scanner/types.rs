    ...
    fn default() -> Self {
        Self {
            ...
            binary_extensions: vec![
                ...
                "bmp".to_string(), "ico".to_string(), "webp".to_string(), "tiff".to_string(), "tif".to_string(),
                "avif".to_string(), "heic".to_string(), "heif".to_string(), "dng".to_string(), "raw".to_string(),
                "nef".to_string(), "cr2".to_string(), "arw".to_string(), "orf".to_string(), "rw2".to_string(),
                // Documents
                "pdf".to_string(), "doc".to_string(), "docx".to_string(), 
                "xls".to_string(), "xlsx".to_string(), "ppt".to_string(), "pptx".to_string(),
                "odt".to_string(), "ods".to_string(), "odp".to_string(), "indd".to_string(),
                // Archives
                ...
                // Fonts
                "ttf".to_string(), "otf".to_string(), "woff".to_string(), "woff2".to_string(), "eot".to_string(),
                ...
                "gcno".to_string(), "gcda".to_string(), "gcov".to_string(),
                "wasm".to_string(), "webc".to_string(),
                // Binary Data & Image Files
                "img".to_string(), "dmg".to_string(), "vhd".to_string(), "vmdk".to_string(),
                "qcow2".to_string(), "raw".to_string(),
                ...
                "com".to_string(), "exe".to_string(), "bat".to_string(), "cmd".to_string(),
